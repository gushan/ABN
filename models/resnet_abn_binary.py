...
from .ABN import BatchNorm

__all__ = ['resnet_abn_binary']
...
class ResNet_ABN_imagenet(ResNet_ABN):

    def __init__(self, num_classes=1000,
                 block=Bottleneck, layers=[3, 4, 23, 3]):
        super(ResNet_ABN_imagenet, self).__init__()
        self.inplanes = 64
...
class ResNet_ABN_tiny_imagenet(ResNet_ABN):

    def __init__(self, num_classes=10,
                 block=BasicBlock, depth=18):
        super(ResNet_ABN_tiny_imagenet, self).__init__()
        self.inflate = 5
        ...
        self.bn1 = BatchNorm(16*self.inflate)
        self.tanh1 = nn.Hardtanh(inplace=True)
        self.tanh2 = nn.Hardtanh(inplace=True)
...
class ResNet_ABN_cifar10(ResNet_ABN):

    def __init__(self, num_classes=10,
                 block=BasicBlock, depth=18):
        super(ResNet_ABN_cifar10, self).__init__()
        self.inflate = 5
        self.inplanes = 16*self.inflate
        n = int((depth - 2) / 6)
        self.conv1 = nn.Conv2d(3, 16*self.inflate, kernel_size=3, stride=1, padding=1,
...
def resnet_abn_binary(**kwargs):
    ...
    if dataset == 'imagenet':
        ...
        depth = depth or 50
        if depth == 18:
            return ResNet_ABN_imagenet(num_classes=num_classes,
        ...
        depth = depth or 18
        return ResNet_ABN_cifar10(num_classes=num_classes,
        ...
        depth = depth or 18
        return ResNet_ABN_tiny_imagenet(num_classes=num_classes,
                              block=BasicBlock, depth=depth)