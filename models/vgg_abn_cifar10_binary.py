...
def vgg_abn_cifar10_binary(**kwargs):
    input_size = kwargs.get('input_size', 32)
    num_classes = kwargs.get( 'num_classes', 10)
    return VGG_ABN_Cifar10(input_size, num_classes)


def vgg_abn_cifar100_binary(**kwargs):
    input_size = kwargs.get('input_size', 32)
    num_classes = kwargs.get( 'num_classes', 100)
    return VGG_ABN_Cifar10(input_size, num_classes)

def vgg_abn_tiny_imagenet_binary(**kwargs):
